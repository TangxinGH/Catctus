    ...
    private val hashMap: HashMap<String, List<String>> =
        object : HashMap<String, List<String>>() {
            init {
                ...
                //酷派
                put(
                    "coolpad" /*厂商名称不确定是否正确*/, Arrays.asList(
                ...
                //联想
                put(
                    "lenovo" /*厂商名称不确定是否正确*/, Arrays.asList(
                        "com.lenovo.security/.purebackground.PureBackgroundActivity",
                        "com.lenovo.security"
                    )
                )
                put(
                    "htc" /*厂商名称不确定是否正确*/, Arrays.asList(
                ...
                //华硕
                put(
                    "asus" /*厂商名称不确定是否正确*/, Arrays.asList(
                ...
                for (act in actCompatList) {
                    try {
                        ...
                        if (act.contains("/")) {
                            ...
                            val componentName =
                                ComponentName.unflattenFromString(act)
