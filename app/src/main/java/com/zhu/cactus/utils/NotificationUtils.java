...
public class NotificationUtils extends ContextWrapper {
    ...
    private Notification.Style style=null;
/**
* 大图标
* @param LargeIcon                   大图标
 * @return
 */
     ...
     * @return
     */
    public NotificationUtils setLargeIcon(Notification.Style style) {
        this.style = style;
        return this;
    }


    public NotificationUtils setStyle(Notification.Style style) {
        this.style = style;
        return this;
    }
